#!/bin/bash
# Run pipeline on all SJB dates sequentially on GPU 0
# Tracks progress per-video in progress_sjb.log — safe to restart
...
CONFIG="$WORKDIR/config_sjb.yaml"
...
for DATE in "${DATES[@]}"; do
  VIDEO_DIR="D:/Video_recording/Connected_intersection/EDK_st and SJB/${DATE}"
